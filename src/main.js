...
const MODRINTH_USER_AGENT = 'Lukas3578/Vortex-launcher/0.4.9 (github.com/Lukas3578/Vortex-launcher)';
...
function makeCosmeticSkin(version, sourceFile, hat, emblem) {
  ...
  const profile = { baseSkin: path.basename(sourceTarget), generatedSkin: generatedName, hat, emblem, createdAt: new Date().toISOString(), launcher: 'Vortex Client Launcher 0.4.9' };
