...
contextBridge.exposeInMainWorld('vortex', {
  ...
  startHostedServer: (version, port, eulaAccepted) => ipcRenderer.invoke('start-hosted-server', version, port, eulaAccepted),
  stopHostedServer: (version) => ipcRenderer.invoke('stop-hosted-server', version),
  hostedServerStatus: (version) => ipcRenderer.invoke('hosted-server-status', version),
  ...
  listModpackMods: (instanceId) => ipcRenderer.invoke('list-modpack-mods', instanceId),
  downloadModpackMod: (instanceId, mod) => ipcRenderer.invoke('download-modpack-mod', instanceId, mod),
  toggleModpackMod: (instanceId, fileName) => ipcRenderer.invoke('toggle-modpack-mod', instanceId, fileName),
  removeModpackMod: (instanceId, fileName) => ipcRenderer.invoke('remove-modpack-mod', instanceId, fileName),
  ...
  cancelVideoRecording: (id) => ipcRenderer.invoke('cancel-video-recording', id),
  ...
  importExternalModFiles: (version) => ipcRenderer.invoke('import-external-mod-files', version),
  transferModrinthProfile: (version) => ipcRenderer.invoke('transfer-modrinth-profile', version),
  transferVersionContent: (sourceVersion, targetVersion) => ipcRenderer.invoke('transfer-version-content', sourceVersion, targetVersion),
  ...
  onAccountsUpdated: (callback) => ipcRenderer.on('accounts-updated', (_event, value) => callback(value)),
