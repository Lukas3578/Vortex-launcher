...
contextBridge.exposeInMainWorld('vortex', {
  ...
  saveStudioSkin: (version, skinData, sourceName) => ipcRenderer.invoke('skin-studio-save', version, skinData, sourceName),
  listCommunitySkins: () => ipcRenderer.invoke('community-list-skins'),
  uploadCommunitySkin: (metadata) => ipcRenderer.invoke('community-upload-skin', metadata),
  downloadCommunitySkin: (shareCode) => ipcRenderer.invoke('community-download-skin', shareCode),
  useCommunitySkin: (shareCode, version) => ipcRenderer.invoke('community-use-skin', shareCode, version),
